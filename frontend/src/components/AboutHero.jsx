...
// const AboutHero = () => {
//   return (
//     <section className="bg-[linear-gradient(180deg,_#FFF_12.98%,_rgba(184,199,243,0.44)_52.73%,_rgba(29,78,216,0.43)_100%)] text-white py-12 px-4 md:px-12 mb-1 shadow-xl">
